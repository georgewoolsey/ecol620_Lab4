...
<span style="color: teal;">
The NLCD raster of Fort Collins contains **`r np_temp[[1]]`** patches of evergreen forest using a 4-neighborhood rule and **`r np_temp[[2]]`** patches of evergreen forest using a 8-neighborhood rule.
</span>
...
# calculate correlation matrix
  ...
  cor_matrix_df %>% 
    ...
    kableExtra::kable(
      format = "html" 
      , caption = "<font size=-1>Top 3 negative correlations in patch-based metrics for NLCD class: open water</font>"
      , escape = FALSE
      , digits = 2
      , col.names = c(
        "Metric 1"
